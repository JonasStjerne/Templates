...
var app = (function () {
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = text(t0_value);
    			t1 = space();
    			add_location(p, file, 39, 1, 1008);
    			add_location(div, file, 38, 1, 1001);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 31, 0, 704);
    			add_location(h30, file, 33, 0, 791);
    			attr_dev(input0, "type", "text");
    			add_location(input0, file, 35, 1, 878);
    			attr_dev(form, "autocomplete", "off");
    			add_location(form, file, 34, 0, 814);
    			add_location(h31, file, 44, 0, 1097);
    			attr_dev(input1, "type", "search");
    			attr_dev(input1, "id", "dawa-autocomplete-input");
    			attr_dev(input1, "class", "svelte-1qhp4sz");
    			add_location(input1, file, 46, 1, 1163);
    			attr_dev(div, "class", "autocomplete-container svelte-1qhp4sz");
    			add_location(div, file, 45, 0, 1125);
    		},
    ...
    function create_fragment(ctx) {
    	let dawa;
    	let current;
    	dawa = new DAWA({ $$inline: true });

    	const block = {
    		c: function create() {
    			create_component(dawa.$$.fragment);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			mount_component(dawa, target, anchor);
    			current = true;
    		},
    		p: noop,
    		i: function intro(local) {
    			if (current) return;
    			transition_in(dawa.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(dawa.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			destroy_component(dawa, detaching);
    		}
    	};
